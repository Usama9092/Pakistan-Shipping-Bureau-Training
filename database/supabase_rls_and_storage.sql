...
-- Phase 2 defense-in-depth: direct browser roles do not receive table privileges by default.
-- The application continues to use the server-side Supabase service role.
REVOKE ALL ON TABLE accreditation_assessments FROM anon, authenticated;
REVOKE ALL ON TABLE accreditation_evidence FROM anon, authenticated;
REVOKE ALL ON TABLE annual_reviews FROM anon, authenticated;
REVOKE ALL ON TABLE assessment_history FROM anon, authenticated;
REVOKE ALL ON TABLE audit_trail FROM anon, authenticated;
REVOKE ALL ON TABLE authorization_certificates FROM anon, authenticated;
REVOKE ALL ON TABLE authorization_events FROM anon, authenticated;
REVOKE ALL ON TABLE authorization_matrix FROM anon, authenticated;
REVOKE ALL ON TABLE authorization_requests FROM anon, authenticated;
REVOKE ALL ON TABLE authorization_restrictions FROM anon, authenticated;
REVOKE ALL ON TABLE backup_records FROM anon, authenticated;
REVOKE ALL ON TABLE capa_register FROM anon, authenticated;
REVOKE ALL ON TABLE client_feedback FROM anon, authenticated;
REVOKE ALL ON TABLE competency_matrix FROM anon, authenticated;
REVOKE ALL ON TABLE competency_ncrs FROM anon, authenticated;
REVOKE ALL ON TABLE competency_reviews FROM anon, authenticated;
REVOKE ALL ON TABLE cpd_records FROM anon, authenticated;
REVOKE ALL ON TABLE crb_reviews FROM anon, authenticated;
REVOKE ALL ON TABLE departments FROM anon, authenticated;
REVOKE ALL ON TABLE development_plans FROM anon, authenticated;
REVOKE ALL ON TABLE files FROM anon, authenticated;
REVOKE ALL ON TABLE gap_advisor_actions FROM anon, authenticated;
REVOKE ALL ON TABLE interpretation_reviews FROM anon, authenticated;
REVOKE ALL ON TABLE job_assignments FROM anon, authenticated;
REVOKE ALL ON TABLE job_requests FROM anon, authenticated;
REVOKE ALL ON TABLE knowledge_acknowledgements FROM anon, authenticated;
REVOKE ALL ON TABLE knowledge_library FROM anon, authenticated;
REVOKE ALL ON TABLE knowledge_versions FROM anon, authenticated;
REVOKE ALL ON TABLE kpi_records FROM anon, authenticated;
REVOKE ALL ON TABLE kpi_snapshots FROM anon, authenticated;
REVOKE ALL ON TABLE notifications FROM anon, authenticated;
REVOKE ALL ON TABLE permissions FROM anon, authenticated;
REVOKE ALL ON TABLE qms_audits FROM anon, authenticated;
REVOKE ALL ON TABLE qms_compliance_items FROM anon, authenticated;
REVOKE ALL ON TABLE qms_evidence_reviews FROM anon, authenticated;
REVOKE ALL ON TABLE qms_management_reviews FROM anon, authenticated;
REVOKE ALL ON TABLE question_bank FROM anon, authenticated;
REVOKE ALL ON TABLE recovery_requests FROM anon, authenticated;
REVOKE ALL ON TABLE revalidation_requests FROM anon, authenticated;
REVOKE ALL ON TABLE role_permissions FROM anon, authenticated;
REVOKE ALL ON TABLE roles FROM anon, authenticated;
REVOKE ALL ON TABLE rule_change_requests FROM anon, authenticated;
REVOKE ALL ON TABLE rule_library FROM anon, authenticated;
REVOKE ALL ON TABLE succession_plans FROM anon, authenticated;
REVOKE ALL ON TABLE supervised_activities FROM anon, authenticated;
REVOKE ALL ON TABLE system_settings FROM anon, authenticated;
REVOKE ALL ON TABLE technical_authorities FROM anon, authenticated;
REVOKE ALL ON TABLE technical_interpretations FROM anon, authenticated;
REVOKE ALL ON TABLE technical_reviews FROM anon, authenticated;
REVOKE ALL ON TABLE training_modules FROM anon, authenticated;
REVOKE ALL ON TABLE training_records FROM anon, authenticated;
REVOKE ALL ON TABLE training_requirements FROM anon, authenticated;
REVOKE ALL ON TABLE trainings FROM anon, authenticated;
REVOKE ALL ON TABLE user_assignments FROM anon, authenticated;
REVOKE ALL ON TABLE user_departments FROM anon, authenticated;
REVOKE ALL ON TABLE user_permission_overrides FROM anon, authenticated;
REVOKE ALL ON TABLE users FROM anon, authenticated;
REVOKE ALL ON TABLE witness_surveys FROM anon, authenticated;
REVOKE ALL ON TABLE workforce_forecasts FROM anon, authenticated;

-- Phase 3/4: server-side authentication session store is never client-readable.
...
-- Production role/scope RLS helpers. Test in staging before enabling direct browser writes.
...
create or replace function public.psb_can_access_user(target text) returns boolean language sql stable security definer set search_path=public as $$
select case
when public.psb_is_org_role() then true
when target=public.psb_current_user_id() then true
else exists(
  select 1 from users u
  where u.user_id=target
    and (u.tutor_id=public.psb_current_user_id()
      or u.mentor_id=public.psb_current_user_id()
      or u.trainer_id=public.psb_current_user_id()
      or u.assigner_id=public.psb_current_user_id())
)
end $$;

-- Example scoped policies: direct browser access stays read-only unless your deployment explicitly grants write paths.
alter table users enable row level security;
drop policy if exists psb_users_self_or_org on users;
create policy psb_users_self_or_org on users for select to authenticated using (auth_user_id=auth.uid() or public.psb_is_org_role());

alter table training_records enable row level security;
drop policy if exists psb_training_records_scope on training_records;
create policy psb_training_records_scope on training_records for select to authenticated using (public.psb_can_access_user(user_id));

alter table cpd_records enable row level security;
drop policy if exists psb_cpd_scope on cpd_records;
create policy psb_cpd_scope on cpd_records for select to authenticated using (public.psb_can_access_user(user_id));

alter table development_plans enable row level security;
drop policy if exists psb_development_scope on development_plans;
create policy psb_development_scope on development_plans for select to authenticated using (public.psb_can_access_user(user_id));

alter table competency_matrix enable row level security;
drop policy if exists psb_competency_scope on competency_matrix;
create policy psb_competency_scope on competency_matrix for select to authenticated using (public.psb_can_access_user(user_id));

alter table authorization_requests enable row level security;
drop policy if exists psb_authorization_scope on authorization_requests;
create policy psb_authorization_scope on authorization_requests for select to authenticated using (public.psb_can_access_user(user_id));

alter table authorization_restrictions enable row level security;
drop policy if exists psb_restrictions_scope on authorization_restrictions;
create policy psb_restrictions_scope on authorization_restrictions for select to authenticated using (public.psb_can_access_user(user_id));

alter table job_requests enable row level security;
drop policy if exists psb_job_requests_scope on job_requests;
create policy psb_job_requests_scope on job_requests for select to authenticated using (public.psb_is_org_role() or assigned_user_id=public.psb_current_user_id() or created_by=public.psb_current_user_id());

alter table client_feedback enable row level security;
drop policy if exists psb_feedback_scope on client_feedback;
create policy psb_feedback_scope on client_feedback for select to authenticated using (public.psb_is_org_role() or user_id=public.psb_current_user_id());

alter table qms_audits enable row level security;
drop policy if exists psb_qms_audit_scope on qms_audits;
create policy psb_qms_audit_scope on qms_audits for select to authenticated using (public.psb_is_org_role() or lead_auditor_id=public.psb_current_user_id());

alter table technical_reviews enable row level security;
drop policy if exists psb_technical_review_scope on technical_reviews;
create policy psb_technical_review_scope on technical_reviews for select to authenticated using (public.psb_is_org_role() or public.psb_can_access_user(user_id) or reviewer_id=public.psb_current_user_id());

alter table kpi_snapshots enable row level security;
drop policy if exists psb_kpi_snapshot_scope on kpi_snapshots;
create policy psb_kpi_snapshot_scope on kpi_snapshots for select to authenticated using (public.psb_is_org_role() or user_id=public.psb_current_user_id());

-- No direct browser access to session secrets or governance audit records.
alter table auth_sessions enable row level security;
drop policy if exists psb_auth_sessions_server_only on auth_sessions;
create policy psb_auth_sessions_server_only on auth_sessions for all to authenticated using (false) with check (false);
